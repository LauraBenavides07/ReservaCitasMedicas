...
export class InitialSchema1780259350395 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_8275d19f8ac53ea4ad1cf7c52d" ON "appointments"  ("doctor_id", "appointment_date", "appointment_time") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8275d19f8ac53ea4ad1cf7c52d"`);
