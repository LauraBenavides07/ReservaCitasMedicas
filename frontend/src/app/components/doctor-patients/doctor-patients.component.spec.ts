...
describe('DoctorPatientsComponent', () => {
  ...
  const mockAllAppointments: Appointment[] = [
    { id: 'apt1', appointmentDate: '2024-12-01', appointmentTime: '09:00', time: '09:00', date: '2024-12-01', status: 'completada', diagnosis: 'Revisión', patient: { firstName: 'Juan', lastName: 'Pérez', document: '12345', phone: '987654321' }, doctor: { id: 'doc1', name: 'Carlos Médina', specialty: 'Cardiología', scheduleStart: '08:00', scheduleEnd: '17:00', slotDuration: 30, activeDays: [1, 2, 3, 4, 5] } },
    ...
    { id: 'apt3', appointmentDate: '2024-10-10', appointmentTime: '11:00', time: '11:00', date: '2024-10-10', status: 'completada', diagnosis: 'Control', patient: { firstName: 'Ana', lastName: 'García', document: '67890', phone: '123456789' }, doctor: { id: 'doc1', name: 'Carlos Médina', specialty: 'Cardiología', scheduleStart: '08:00', scheduleEnd: '17:00', slotDuration: 30, activeDays: [1, 2, 3, 4, 5] } },
